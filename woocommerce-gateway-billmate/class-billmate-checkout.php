    ...
    public function save_wc2_customer()
    {
        ...
        if( isset($post['Customer'])
            ...
            $billing_address = array(
                ...
                'address_2'  => (isset($post['Customer']['Billing']['street2']) ? $post['Customer']['Billing']['street2'] : ''),
            ...
            if( isset($post['Customer']['Shipping'])
                ...
                $shipping_address = array(
                    ...
                    'address_2'  => (isset($post['Customer']['Shipping']['street2']) ? $post['Customer']['Shipping']['street2'] : ''),
